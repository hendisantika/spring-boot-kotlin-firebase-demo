...
class DemoApplication {
    val firebaseConfigPath = "path/to/your/json"
    val firebaseDatabseUrl = "https://spring-boot-kotlin.firebaseio.com/" // your firebase database
    ...
    fun init(repository: PersonRepository, fb: DatabaseReference) = CommandLineRunner {
        repository.save(Person("Hendi", "Santika"))
        repository.save(Person("Uzumaki", "Naruto"))
        repository.save(Person("Uchiha", "Sasuke"))
        repository.save(Person("Muhammad", "Alfatih", "Java"))
        repository.save(Person("Abdul", "Wahab", "Python"))
